...
relocate_inst:
	...
	move $a0, $s3
	move $a1, $s1
	jal symbol_for_addr  # Look for byte offset in relocation table
	addiu $t4, $0, -1
	...
	srl $t1, $v0, 2      # Shift jump address right by 2
	srl $v0, $s0, 26	 # Put the opcode in $v0
	sll $v0, $v0, 26
	or $v0, $v0, $t1     # Put the correct instruction in $v0
